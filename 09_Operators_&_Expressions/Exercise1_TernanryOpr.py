...
#Ex27: Write a program to determine whether an entered salary qualifies for income tax based on a specified threshold using the if..else operator.
...
#Ex28: Write a program to determine whether a person can enter a movie theater based on the age restriction using the if..else operator.
age= int(input("Enter youe age: "))
res= "You can enter in a movie theatre" if age>=18 else "You are not allowed to enter in a movie theatre"
print("Your age is {} so {}".format(age,res))

#Ex29: Write a program to determine whether a student is eligible for a scholarship based on marks using the if..else operator.
cgpa= float(input("Enter Your CGPA: "))
res= "You are eligible for scholarship" if cgpa>=9.5 else "You are not eligible for scholarship"
print("Your CGPA is {} so {}".format(cgpa, res))

# #Ex30: Write a program to compare two strings and display whether they are equal or not using the if..else operator.
s1= input("Enter first string: ")
s2= input("Enter second string: ")
res = "Equal" if s1==s2 else "Not Equal"
print("{} and {}= {} ".format(s1,s2,res))