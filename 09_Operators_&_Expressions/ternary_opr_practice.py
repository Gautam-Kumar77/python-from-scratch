...
#6 Write a program to determine whether a student is eligible for a scholarship based on marks using  if..else operator.
cgpa= float(input("Enter Your Marks: "))
result= "You are Eligible for Scholarship" if (cgpa>9.5) and (cgpa<=10) else "You are not eligible"
print("{}". format(result))
